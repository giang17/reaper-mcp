...
register_profile(StyleProfile(
    ...
    instrument_roles={
        ...
        "drums":         InstrumentRole(eq=drums_bus(), comp=comp_drums_bus(), volume_db=-2.0,
                                         sends=[ReverbSend("plate", -10.0), ReverbSend("room", -13.0)]),
    ...
    aliases=default_aliases(["kick", "snare", "hats", "toms", "cymbals", "drums",
                              "bass_guitar", "rhythm_guitar", "lead_guitar", "clean_guitar",
...
register_profile(StyleProfile(
    ...
    instrument_roles={
        ...
        "drums":         InstrumentRole(eq=drums_bus(), comp=comp_drums_bus(), volume_db=-2.0,
                                         sends=[ReverbSend("room", -8.0), ReverbSend("plate", -11.0)]),
...
register_profile(StyleProfile(
    ...
    instrument_roles={
        ...
        "toms":          InstrumentRole(eq=perc_bright(), volume_db=-5.0,
                                         sends=[ReverbSend("room", -10.0)]),
        "cymbals":       InstrumentRole(eq=hats(), volume_db=-12.0),
        "drums":         InstrumentRole(eq=drums_bus(), comp=comp_drums_bus(), volume_db=-1.0,
...
register_profile(StyleProfile(
    ...
    aliases=default_aliases(["kick", "snare", "hats", "cymbals", "drums",
...
register_profile(StyleProfile(
    ...
    instrument_roles={
        ...
        "cymbals":       InstrumentRole(eq=hats(), volume_db=-10.0,
                                         sends=[ReverbSend("hall", -8.0)]),
        "drums":         InstrumentRole(eq=drums_bus(), comp=comp_drums_bus(), volume_db=-4.0,
                                         sends=[ReverbSend("hall", -6.0), ReverbSend("plate", -9.0)]),
        "bass_guitar":   InstrumentRole(eq=bass_guitar(), comp=comp_bass_edm(), volume_db=-4.0),
        "rhythm_guitar": InstrumentRole(eq=rhythm_guitar(), volume_db=-5.0, pan=-0.5,
